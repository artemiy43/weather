    ...
    return (
      <div className={isOpen === true ? "menu" : "menu-unable"} id="menu">
        <div className="menu__flex-container">
          ...
          <button className="menu__button" type="button" onClick={handleIsOpen}>
            <span>{isOpen === true ? "Закрыть" : "Открыть"}</span>
          </button>
          <img
            className={isOpen === true ? "menu__pic" : "menu__pic-unable"}
            src={pic}
            alt="погода"
          />
        </div>
        <div
          className={
            isOpen === true
              ...
              : "menu__grid-container-unable"
          }
        >
          <p className="menu__span-coordinates">
            {parametres.weather[0].description}
          </p>
